    ...
    private void loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginMouseClicked
         if(evt.getSource()==login)
        {
            if(uname.getText().length()==0 && pass.getText().length()==0)
            {
                ...
                if(uname.getText().equals("Akash") && pass.getText().equals("7879") || uname.getText().equals("Sanket") && pass.getText().equals("0007") || uname.getText().equals("Aniket") && pass.getText().equals("1234"))
            {
