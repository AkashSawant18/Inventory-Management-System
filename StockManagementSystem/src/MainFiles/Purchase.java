    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/Stock_Management", "root", "");
...
// TODO add your handling code here:
    ...
    private void jTextField3MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField3MouseExited
      ...
      int N1=Integer.parseInt(qun);
        ...
        jTextField5.setText(String.valueOf(N4));  // TODO add your handling code here:
            ...
            System.out.println("MainFiles.Purchase.jTextField3MouseExited()");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String totprice = jTextField5.getText();
             ...
             Class.forName("com.mysql.cj.jdbc.Driver");
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Stock_Management","root","");
          ...
          public void workWithDatabase()
    {
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");
       c=DriverManager.getConnection("jdbc:mysql://localhost/Stock_Management","root","");
       s=c.createStatement();
